...
y_pred = kmeans.fit_predict(principal_data_Df)
print (y_pred)
...
print (principal_data_Df.iloc[:, 0])
print (principal_data_Df.iloc[0, :])
plt.figure(figsize=(11, 4))
plot_clusters_coloured(principal_data_Df,XY_train)
plt.figure(figsize=(12, 4))
plot_decision_boundaries(kmeans, principal_data_Df,XY_train)
plt.show()
plt.show()
