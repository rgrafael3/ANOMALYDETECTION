...
training_dataXY, testing_dataXY = train_test_split(AllXY, test_size=0.1, random_state=25)
...
fitting = SVC(random_state=0,C=0.001,max_iter=1000000000,kernel="linear").fit(normalisedTrainingDataX, training_dataXY[15])
...
svc_disp = RocCurveDisplay.from_estimator(fitting, testing_dataXY.drop([15], axis=1), y)
plt.show()