...
X_trainNormal = pd.read_csv("C://IUBH//tesis//apache-jmeter-5.5//apache-jmeter-5.5//resultadosNormal.csv",sep=",", header=0)
X_trainNotNormal = pd.read_csv("C://IUBH//tesis//apache-jmeter-5.5//apache-jmeter-5.5//resultadosProblem.csv",sep=",", header=0)

AllX_train=pd.concat([X_trainNormal, X_trainNotNormal])
AllX_train.head()
#X_train=AllX_train[["elapsed","responseCode","bytes","sentBytes","grpThreads","allThreads","Latency","IdleTime","Connect"]]
X_train=AllX_train[["elapsed","bytes","sentBytes","grpThreads","allThreads","Latency","IdleTime"]]
X_trainNormal["y"]=0
